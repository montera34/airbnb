...
En esta gráfica se observa que la composición de los sectores comerciales más representativos que hemos seleccionado, con relación a cada barrio analizado, muestra una distribución heterogénea.
...
<iframe id="datawrapper-chart-zDPxR" src="//datawrapper.dwcdn.net/zDPxR/2/" scrolling="no" frameborder="0" allowtransparency="true" style="width: 0; min-width: 100% !important;" height="254"></iframe><script type="text/javascript">


# ¿Cómo seguir a partir del trabajo realizado?

+ Realizar estudio estadístico completo de los 74 barrios de Barcelona agrupados en función del Plan Especial Urbanístico de Alojamiento Turístico (PEUAT) o ratios similares de ofertas de AirBnB.
+ Realizar un estudio de la evolución del tipo de comercios de 2014 al 2016, y ver si hay resultados significativos. 
+ Realizar una metodología de estudio que permita detectar cambios significativos en categorías clave a medida que se vayan publicando nuevos datos sobre comercios. 


## Datos

+ [Inventario de locales de la ciudad de Barcelona](http://opendata-ajuntament.barcelona.cat/data/es/dataset/cens-activitats-comercials) (2014, 2016). Inventario de locales de la ciudad de Barcelona con el objetivo de identificar todos los locales en planta baja con actividad económica o sin actividad. 

+ [Plan Especial Urbanístico de Alojamiento Turístico](http://ajuntament.barcelona.cat/pla-allotjaments-turistics/es/) (PEUAT).


+ [Anuncios de Airbnb de InsedeAirbnb](http://data.insideairbnb.com/spain/catalonia/barcelona/2018-09-11/visualisations/listings.csv) (08/12/2016) 


+ [Población oficial por barrios año a año y sexo de la ciudad de Barcelona](http://opendata-ajuntament.barcelona.cat/data/es/dataset/est-ine-edat-any-a-any/resource/c2a6802e-cde0-40d8-917d-f3107f357b8a) (2016).

+ Referencias: estudio de evolución de comercio en Madrid: https://docs.google.com/document/d/10_ef3ZnlVpkwurIkI_IWNoHQDD6nxM7g4MDl5vmZUzg/edit# (de ejercicio en el taller de datos de la turistificación de Madrid)
